# Run Dev Server (Node backend) - starts Node backend and Vite frontend, shows full logs
...
Write-Host ""
Write-Host "Starting Node backend server at http://127.0.0.1:5174 ..."
...
Write-Host "Proxy targets: /api and /uploads -> http://127.0.0.1:5174"
